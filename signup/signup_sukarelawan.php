  ...
  <body class="font-poppins">
    ...
    <div class="lg:w-full h-screen flex flex-col lg:flex-row items-center justify-center">
      ...
      <div class="lg:w-full sm:w-5/6 md:w-2/3 xl:w-1/3 2xl:w-1/4 w-[80vw] h-[70vh] lg:h-full bg-black1 flex flex-col items-center justify-start py-8 px-[8vw] lg:px-10 overflow-scroll lg:overflow-auto rounded-xl lg:rounded-none">
        ...
        <form class="text-xs sm:text-base">
          <div class="flex flex-col my-4 sm:my-7">
            <label for="name" class="text-palewhite">Nama</label>
            <input type="text" name="name" id="name" class="mt-2 p-2 focus:outline-none focus:ring-0 rounded text-xs sm:text-base text-black1" placeholder="Masukkan nama" />
          </div>

          <div class="flex flex-col my-4">
            <label for="email" class="text-palewhite">Alamat email</label>
            <input type="email" name="email" id="email" class="mt-2 p-2 border focus:outline-none focus:ring-0 rounded text-xs sm:text-base text-black1" placeholder="Masukkan email" />
          </div>
          ...
          <div class="flex flex-col my-4">
            ...
            <div x-data="{ show: false }" class="relative flex items-center mt-2">
              <input
                ...
                name="password"
                id="password"
                class="flex-1 p-2 pr-10 border focus:outline-none focus:ring-0 rounded text-xs sm:text-base text-black1"
          ...
          <div class="my-4 flex items-center justify-center lg:justify-end space-x-4">
            <button class="bg-purple1 hover:bg-blue-400 rounded-lg text-xs sm:text-base px-[5vw] py-2 text-palewhite hover:shadow-xl transition duration-150 uppercase">Sign Up</button>
          </div>
        </form>
