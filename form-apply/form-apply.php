...
<html lang="en">
  ...
  <body class="font-poppins">
    <img src="../src/img/background.svg" alt="" class="background-svg block -z-10" />
    ...
    <div class="flex h-screen w-full items-center justify-center ">
      <div class="w-[80vw]  max-w-sm h-[90vh] max-h-[30rem] login-area rounded-xl bg-black1 bg-opacity-50 px-16 py-10 shadow-lg backdrop-blur-md max-sm:px-8 duration-1000 relative ">
          ...
          <div class="mb-8 flex flex-col items-center text-center text-palewhite">
            <img src="../src/img/logo.svg" width="100" alt="" />
            <h1 class="mb-2 text-2xl mt-3">Volunteeria</h1>
          ...
          <form action="../config/form.php" class="flex flex-col items-center overflow-y-auto h-[55%] lg:h-[65%] apply-form">
            ...
            <div class="my-4 flex items-center justify-center lg:justify-end space-x-4">
              <button type="submit" class="bg-purple1 hover:bg-blue-400 rounded-lg text-xs sm:text-base px-[5vw] py-2 text-palewhite hover:shadow-xl transition duration-150 uppercase">Kirim</button>
            </div>
          </form>
        </div>
      </div>
