...
<body class="bg-white2 dark:bg-black2 font-poppins">
  ...
  <nav class="bg-white dark:bg-black1 sm:py-8 sm:pr-20 sm:pl-16 max-sm:px-5 flex items-center justify-between drop-shadow-[0_ 5px_15px_white] text-black1 dark:text-palewhite relative hover:opacity-100 duration-1000 z-20 backdrop-blur-md">
    ...
    <button class="hamburger relative lg:hidden elative flex overflow-hidden items-center justify-center rounded-full w-[50px] h-[50px] transform transition-all bg-purple1 ring-white ring-opacity-30 duration-200 shadow-md burger-ring">
    ...
    <ul class="hidden lg:flex gap-x-5 text-sm items-center">
      <li>
        <a href="#" class="nav-links hoverable-link text-purple1">Lowongan Volunteer</a>
      </li>
      <li>
        <a href="../index.html" class="nav-links hoverable-link">Company Profiles</a>
      </li>
      <li>
        <a href="../tips-volunteer/tips-volunteer.html" class="nav-links hoverable-link">Tips Volunteer</a>
      </li>
      <li><a href="http://localhost:8000/admin/login" class="nav-links border border-purple1 px-4 py-5 rounded-full hover:border-black1 dark:hover:border-palewhite">FOR EMPLOYERS</a></li>
      <li>
  ...
  <aside id="default-sidebar" class="lg:hidden side-navbar fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full" aria-label="Sidebar">
    <div class="h-full px-3 py-10 overflow-y-auto bg-gray-50 dark:bg-black1">
      <ul class="space-y-2 font-medium">
        ...
        <li>
          <a href="../index.html" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-palewhite group">
            <img src="../src/img/company-profile.svg" alt="" class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" />
            <span class="flex-1 ml-3 whitespace-nowrap">Company Profiles</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="http://localhost:8000/admin/" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-palewhite group">
  ...
  <main class="flex flex-col py-5 bg-white2 dark:bg-black1 dark:text-palewhite relative">
    ...
    while ($lowongan = mysqli_fetch_array($query)) {
      $job_id = $lowongan['id'];
    ?>
      <ul class="mt-4 lowongan-container flex flex-col h-fit px-8 items-center gap-5 lg:w-[35vw]">
        <li class="daftar-lowongan" data-id="<?=$job_id?>">
          <a href="./detail-volunteer/detail-volunteer.php">
    ...
    <div class="volunteer-detail-parent overflow-y-scroll fixed right-0 w-[65vw] h-[70%] hidden lg:block bg-white dark:bg-black2 shadow-[0_0_25px_-10px_rgba(0,0,0,0.3)] dark:shadow-[0_0_25px_-15px_rgba(95,122,219,0.5)] rounded-lg">
      <div class="main-image flex flex-col absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 items-center text-black1 dark:text-palewhite">
        <img src="../src/img/wehave.png" alt="" class="w-64 mb-5" />
        <h3 class="font-semibold text-xl text-center">Tersedia berbagai jenis lowongan yang mungkin cocok untuk mu</h3>
      ...
      ?>
        <div class="volunteer-detail hidden" data-id="<?=$daftar_lowongan['id']?>">
          <section class="p-5 bg-white dark:bg-black1 dark:text-palewhite rounded-b-lg text-center">
            ...
            <button class="rounded-md bg-purple1 w-full h-12 mt-10 mx-auto text-white">Apply Now</button>
          </section>
