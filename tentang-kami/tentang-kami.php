  ...
  <main class="w-full h-fit bg-white2">
    ...
    <section class="py-10 px-5 bg-white dark:bg-black1">
      ...
      <div class="flex flex-col sm:flex-row gap-5 justify-center items-center">
        <div>
          <div class="bg-white2 w-[80%] max-w-sm mx-auto rounded-t-xl shadow-xl min-h-fit pt-10 flex items-end">
            <img src="../src/img/afridho.png" alt="Afridho Image" class="contributor-profile" />
          </div>
          <h3 class="contributor-name">Afridho Ikhsan</h3>
          <p class="contributor-part">Frontend</p>
        </div>

        <div class="">
          <div class="bg-white2 w-[80%] max-w-sm mx-auto rounded-t-xl shadow-xl min-h-fit pt-10 flex items-end">
            <img src="../src/img/alif.png" alt="Alif Image" class="contributor-profile" />
          </div>
          <h3 class="contributor-name">Alif Fadillah Ummar</h3>
          <p class="contributor-part">Backend</p>
        </div>
      </div>
    </section>
          ...
          <div class="mt-12 grid items-center lg:grid-cols-2 border border-palewhite rounded-lg justify-items-center px-5">
            ...
            <div class="divide-y divide-gray-200 dark:divide-palewhite py-5">
              ...
              <div class="relative w-full h-96 mt-5 rounded-lg">
                <iframe class="absolute top-0 left-0 w-full h-full rounded-lg" src="https://maps.google.com/maps?width=600&amp;height=400&amp;hl=en&amp;q=universitas singaperbangsa karawang&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed" frameborder="0" style="border: 0" allowfullscreen="" aria-hidden="false" tabindex="0">
                </iframe>
              </div>
            </div>
          </div>
